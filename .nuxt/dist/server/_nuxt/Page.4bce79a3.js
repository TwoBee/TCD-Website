...
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrGetDirectiveProps } from "vue/server-renderer";
...
const baseNav_vue_vue_type_style_index_0_scoped_48725e78_lang = "";
const _sfc_main$2 = {
  __name: "base-nav",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      if (unref(mobileMenu)) {
        _push(`<nav class="mobile" data-v-48725e78><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-48725e78><div class="topbottombar" data-v-48725e78><div class="middlebar" data-v-48725e78></div></div></nav>`);
      } else {
        _push(`<!---->`);
      }
      if (mobileNav.value) {
        _push(`<div class="burgermenu_itemlist" data-v-48725e78><ul data-v-48725e78><li data-v-48725e78>Test 1</li><li data-v-48725e78>Test 2</li><li data-v-48725e78>Test 3</li></ul></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--]-->`);
...
const BaseNav = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-48725e78"]]);
const _sfc_main$1 = {
  props: ["data"],
  components: { BaseNav },
  data() {
...
//# sourceMappingURL=Page.4bce79a3.js.map
